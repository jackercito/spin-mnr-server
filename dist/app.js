...
const experimento_routes_1 = require("./routes/experimento.routes");
let origen;
...
app.use('/experimento', jwtCheck, experimento_routes_1.experimentoRoute);
app.use((err, _req, _res, next) => {
    const err2 = new Error('Error: ' + err);
